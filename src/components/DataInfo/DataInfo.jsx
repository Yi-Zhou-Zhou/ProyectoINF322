    ...
    <div className="elementWrapper">
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              <StyledTableCell>ACTUALIZACIONES RECIENTES</StyledTableCell>
              <StyledTableCell align="right">CREADO</StyledTableCell>
              <StyledTableCell align="right">REPORTADO POR&nbsp;</StyledTableCell>
          ...
          <TableBody>
            {rows.map((row) => (
              <StyledTableRow key={row.name}>
                ...
                <StyledTableCell align="right">{row.reportedBy}</StyledTableCell>
